...
\caption{Use-Case: Heap Benutzung}\\\hline
   ...
   Quelle & Raffael Schmid\\\hline
   Verantwortlicher & Raffael Schmid\\\hline
   Kurzbeschreibung & Die Heap Usage (Heap Benutzung) zeigt dem Benutzer an anhand einer Grafik an, zu welchem Zeitpunkt wieviel Speicher des Heaps verwendet wurd. Zusätzlich werden die Zeitpunkte inklusive entsprechendem Typ (Old- / Young-Collection) der Garbage Collection angezeigt.  \\\hline
   Qualitäten & QA-06 (Optimale Wartezeiten)\\\hline
\end{longtable}
...
\caption{Use-Case: Benutzerdefiniert Auswertung }\\\hline
   ...
   Quelle & Raffael Schmid\\\hline
   Verantwortlicher & Raffael Schmid\\\hline
   Kurzbeschreibung & Der Benutzer hat hier die Möglichkeit, von den verfügbaren Daten für X- und Y-Achse einen Messtyp auszuwählen und damit einen Chart zu generieren. \\\hline
   Qualitäten & QA-06 (Optimale Wartezeiten)\\\hline
