...
\caption{Use-Case: Benutzerdefinierte Auswertung speichern, löschen }\\\hline
   ...
   Name & Benutzerdefinierte Auswertung in Profilen speichern, Profile löschen\\\hline
   Autoren & Raffael Schmid\\\hline
   Priorität & Wichtigkeit für Systemerfolg: niedrig\newline Technologisches Risiko: niedrig\\\hline
   Kritikalität & Niedrig\\\hline
   Quelle & Raffael Schmid\\\hline
   Verantwortlicher & Raffael Schmid\\\hline
   Kurzbeschreibung & Verschiedene vom Anwender definierte Charts können in einem Auswertungs-Profil gespeichert werden.\\\hline
   Qualitäten & -\\\hline
\end{longtable}

\begin{longtable}{|p{4cm}|p{10.5cm}|}
\caption{Use-Case: Auswertungsprofile exportieren, importieren }\\\hline
   \textbf{Abschnitt} & \textbf{Inhalt / Erläuterung} \\\hline
   Bezeichner & UC-A-04d2\\\hline
   Name & Auswertungs-Profile exportieren, importieren\\\hline
   Autoren & Raffael Schmid\\\hline
   Priorität & Wichtigkeit für Systemerfolg: niedrig\newline Technologisches Risiko: niedrig\\\hline
   Kritikalität & Niedrig\\\hline
   Quelle & Raffael Schmid\\\hline
   Verantwortlicher & Raffael Schmid\\\hline
   Kurzbeschreibung & Die vom Anwender definierten Profile können als Datei exportiert, und von einem anderen Benutzer importiert werden.\\\hline
   Qualitäten & -\\\hline
\end{longtable}
