...
\subsection{Importierte Dateien speichern (FRQ-03.1)}
...
\section{Datei einlesen (FRQ-04.1)}
...
\section{Logdatei parsen (FRQ-04.2)}
...
\section{Standardauswertung anzeigen (FRQ-04)}
\subsection{Anzeige Übersicht Garbage Collection (FRQ-04.3)}\label{standardreport}
...
\subsection{Chart Anzeige Heap Benutzung (FRQ-04.4)}
...
\subsection{Chart Anzeige Dauer Garbage Collection (FRQ-04.5)}
...
\section{Profil erstellen (FRQ-05)}
...
\subsection{Charts definieren (FRQ-05.1)}
...
\subsection{Profil speichern (FRQ-05.2)}
...
\subsection{Profil exportieren, importieren (FRQ-05.3/ FRQ-05.4)}
